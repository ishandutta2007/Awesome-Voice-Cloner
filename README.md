<div align="center">
  <img src="banner.svg" alt="Awesome Voice Cloner Banner" width="800">
...
## 🔍 SEO & Meta Info
**Keywords:** `AI Voice Cloning`, `Voice Replication`, `Text-to-Speech`, `TTS`, `ElevenLabs Alternative`, `Open Source TTS`, `RVC`, `XTTS-v2`, `AI Dubbing`, `Voice Conversion`, `Real-time Voice Changer`, `Qwen3-TTS`, `Kokoro TTS`.
...
- [🚀 SaaS Products](#-saas-products)
  ...
  - [Voice-First Agents (New 2026)](#voice-first-agents--interactive-clones-new-2026)
...
| **[Uplift AI](https://uplift.ai/)** | **YC** (S25) | Early Access | 🌍 Foundational models for regional languages (Urdu, Bengali, Greek). |

### Voice-First Agents & Interactive Clones (New 2026)

| Name | First Accelerator | Pricing / Free Tier | Focus Area |
| :--- | :--- | :--- | :--- |
| **[DotBridge](https://dotbridge.ai/)** | **YC** (S25) | Contact Sales | 🎥 Interactive video clones for two-way sales & onboarding calls. |
| **[Pickle](https://pickle.ai/)** | **YC** (W25) | Free Trial \| Starts $29/mo | 👥 Real-time digital twins for Zoom, TikTok, and Twitch streamers. |
| **[Bolna AI](https://bolna.ai/)** | **YC** (S25) | Contact Sales | 🇮🇳 Enterprise voice orchestration specifically for the Indian market. |
| **[Leaping AI](https://leaping.ai/)** | **YC** (W25) | Usage-based | ☎️ Human-like voice agents for automating contact centers. |
| **[Codyco](https://codyco.ai/)** | **YC** (S25) | Starts $99/hotel | 🏨 Specialized hospitality agents for hotel bookings and support. |
...
| **[Hessian](https://hessian.ai/)** | **YC** (S25) | Contact for Demo | 📈 Operations automation; narrating business workflows with clones. |
...
| :--- | :--- | :--- |
| **[Qwen3-TTS](https://github.com/QwenLM/Qwen3-TTS)** | **Alibaba** | 👑 2026 King. 3s cloning, 10+ languages, natural language direction. |
| **[Kokoro](https://github.com/hexgrad/kokoro)** | Community | 💎 Ultra-efficient (82M params). Studio quality on edge devices. |
| **[Chatterbox](https://github.com/resemble-ai/chatterbox)** | **Resemble AI** | 🦙 Llama-based with native paralinguistic tags (laughs, sighs). |
| **[Fish Speech S2 Pro](https://github.com/fishaudio/fish-speech)** | **Fish Audio** | 🐟 Massive 10M+ hr training; highly controllable with emotion tags. |
| **[Hume AI TADA](https://github.com/humeai/tada)** | **Hume AI** | 🚫 Zero-hallucination long-form generation. Premium stability. |
| **[VoxCPM2](https://github.com/OpenBMB/VoxCPM)** | **OpenBMB** | 🌍 2B parameter model supporting 30 languages & voice design. |
...
| **[F5-TTS](https://github.com/SWivid/F5-TTS)** | Research (Individual) | 🚀 Fast, high-quality non-autoregressive cloning using DiT. |
...
<div align="center">
  ...
  <a href="https://star-history.com/#ishandutta2007/Awesome-Voice-Cloner&Date">
    <picture>
      ...
      <img alt="Star History Chart" src="https://api.star-history.com/chart?repos=ishandutta2007/Awesome-Voice-Cloner" />
    </picture>
  </a>
